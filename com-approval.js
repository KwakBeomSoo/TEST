any.control("com-approval").define(function behavior(control, controlName)
{
    ...
    (function main() {
        ...
        o.progressBar = (o.$control.attr("progress-bar") == "1");
...
//        html.push('                        <div any-text id="txt_apprPersonSearch_' + o.controlIndex + '"></div>');
        html.push('                        <input type="text" id="txt_apprPersonSearch_' + o.controlIndex + '" style="cursor:pointer; width:100%;"/>');
        html.push('                    </td>');
        html.push('                    <td nowrap>');
        ...
        o.txt_apprPersonSearch = o.$control.find('#txt_apprPersonSearch_' + o.controlIndex).click(function() {
            searchApprPerson();
        });
    ...
    function retrieveApproval(fireEvent)
    {
        ...
        prx.onSuccess = function()
        {
            ...
            if (o.$control.attr("wf-check") == "1" && o.wfActivity != null && o.wfActivity != "") {
                o.readOnly = (o.ds.mainInfo.value(0, "WF_HIST_COUNT") == 0);
            }
...
//        }
    ...
    function doEvent(apprEvent, apprFunc)
    {
        ...
        function getProxy()
        {
            ...
            if (o.progressBar == true) {
                prx.progressbar({
                    defaultLabel: "결재 처리중입니다.",
                    completeLabel: "성공적으로 완료되었습니다."
                });
            }
